...
public class KdbQueryStringBuilderTest
{
    ...
    {
        Assert.assertEquals("myfunc[1970.01.01;1970.01.01]", KdbQueryStringBuilder.pushDownDateCriteriaIntoFuncArgs("myfunc[2021.01.01;2021.01.01]", new DateCriteria(0, 0), null));
        Assert.assertEquals("myfunc[1970.01.02;1970.01.03]", KdbQueryStringBuilder.pushDownDateCriteriaIntoFuncArgs("myfunc[2021.01.01;2021.01.01]", new DateCriteria(1, 2), null));
        Assert.assertEquals("myfunc[2021.08.30;2021.08.30]", KdbQueryStringBuilder.pushDownDateCriteriaIntoFuncArgs("myfunc[2021.01.01;2021.01.01]", new DateCriteria(18869, 18869), null));
    }
    ...
    @Test
    public void buildSql_datepushdown_wherepushdown_between() throws SQLException
    {
        setup();
    ...
    @Test
    public void buildSql_datepushdown_wherepushdown_fallback_between() throws SQLException
    {
        setup();
        ...
        Assert.assertEquals("q) select time, date, sym from func_cfd[1970.01.02;1970.01.03]  where (date within (1970.01.02;1970.01.03)) , (date within (1970.01.02;1970.01.03))", resultSql);
    }
    ...
    @Test
    public void buildSql_datepushdown_nowhereondatepushdown_wherepushdown_sym_in_list_of_symbols() throws SQLException
    {
        setup();
        ...
        Map<String, ValueSet> summary = ImmutableMap.<String, ValueSet>builder()
            ...
            .put("sym" , KdbRecordHandlerTest.getSingleValueSet(new org.apache.arrow.vector.util.Text("USDJPY"), new org.apache.arrow.vector.util.Text("EURUSD")))
            .build();
        Mockito.when(constraints.getSummary()).thenReturn(summary);
        ...
        Assert.assertEquals("q) select time, date, sym from func_cfd[1970.01.02;1970.01.02;((>=; `time; 1970.01.02D09:00:00.000000000); (in; `sym; enlist (`USDJPY; `EURUSD)))]  where ((time >= 1970.01.02D09:00:00.000000000)) , (sym in (`USDJPY; `EURUSD))", resultSql);
    }

    @Test
    public void buildSql_datepushdown_nowhereondatepushdown_wherepushdown_sym_not_in_list_of_symbols() throws SQLException
    {
        LOGGER.info("buildSql_datepushdown_nowhereondatepushdown_wherepushdown_sym_not_in_list_of_symbols...");
        setup();

        Map<String, ValueSet> summary = ImmutableMap.<String, ValueSet>builder()
            .put("date", KdbRecordHandlerTest.getSingleValueSet(1)) // date == 1970.01.02
            .put("time", KdbRecordHandlerTest.getRangeSetLowerOnly(Bound.EXACTLY, new org.apache.arrow.vector.util.Text("1970.01.02D09:00:00.000000000")))
            .put("sym" , KdbRecordHandlerTest.getSortedRangeSetNotIn(new org.apache.arrow.vector.util.Text("EURUSD"), new org.apache.arrow.vector.util.Text("USDJPY")))
            .build();
        Mockito.when(constraints.getSummary()).thenReturn(summary);
        ...
        Assert.assertEquals("q) select time, date, sym from func_cfd[1970.01.02;1970.01.02;((>=; `time; 1970.01.02D09:00:00.000000000); (not; (in; `sym; enlist (`EURUSD; `USDJPY))))]  where ((time >= 1970.01.02D09:00:00.000000000)) , (not[sym in (`EURUSD; `USDJPY)])", resultSql);
    }
    ...
    @Test
    public void buildSql_datepushdown_only_lowerbound_timestamp_between_lower_exactly_upper_exactly() throws SQLException
    {
        setup();

        Map<String, ValueSet> summary = ImmutableMap.<String, ValueSet>builder()
            .put("time", KdbRecordHandlerTest.getRangeSet(
                Bound.EXACTLY, new org.apache.arrow.vector.util.Text("1970.01.02D09:00:00.000000000"),
                Bound.EXACTLY, new org.apache.arrow.vector.util.Text("1970.01.03D09:00:00.000000000")))
            .build();
        Mockito.when(constraints.getSummary()).thenReturn(summary);
        ...
        Assert.assertEquals("q) select time, date, sym from func_cfd[1970.01.02;1970.01.03]  where (date within (1970.01.02;1970.01.03)) , (time within (1970.01.02D09:00:00.000000000;1970.01.03D09:00:00.000000000))", resultSql);
    }

    @Test
    public void buildSql_datepushdown_only_lowerbound_timestamp_between_lower_above_upper_exactly() throws SQLException
    {
        setup();

        Map<String, ValueSet> summary = ImmutableMap.<String, ValueSet>builder()
            .put("time", KdbRecordHandlerTest.getRangeSet(
                Bound.ABOVE  , new org.apache.arrow.vector.util.Text("1970.01.02D09:00:00.000000000"),
                Bound.EXACTLY, new org.apache.arrow.vector.util.Text("1970.01.03D09:00:00.000000000")))
            .build();
        Mockito.when(constraints.getSummary()).thenReturn(summary);
        ...
        Assert.assertEquals("q) select time, date, sym from func_cfd[1970.01.02;1970.01.03]  where (date within (1970.01.02;1970.01.03)) , ((time > 1970.01.02D09:00:00.000000000) and (time <= 1970.01.03D09:00:00.000000000))", resultSql);
    }

    @Test
    public void buildSql_datepushdown_only_lowerbound_timestamp_between_lower_exactly_upper_below() throws SQLException
    {
        setup();
        ...
        Map<String, ValueSet> summary = ImmutableMap.<String, ValueSet>builder()
            .put("time", KdbRecordHandlerTest.getRangeSet(
                Bound.EXACTLY, new org.apache.arrow.vector.util.Text("1970.01.02D09:00:00.000000000"),
                Bound.BELOW  , new org.apache.arrow.vector.util.Text("1970.01.03D09:00:00.000000000")))
            .build();
        Mockito.when(constraints.getSummary()).thenReturn(summary);
    ...
    @Test
    public void buildSql_datepushdown_only_lowerbound_timestamp_between_lower_above_upper_below() throws SQLException
    {
        setup();
    ...
    @Test
    public void buildSql_datepushdown_only_lowerbound_timestamp_exactly() throws SQLException
    {
        setup();
